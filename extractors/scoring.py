...
PATTERN_SPECIFICITY: Dict[str, float] = {
    ...
    # DSE-018 Wave 1 — High specificity
    "renewability_lifetime": 1.0,
    "claim_settlement_days": 1.0,
    "claim_settlement_investigation_days": 0.9,
    "ayush_coverage_present": 1.0,
    "ambulance_amount_inr": 1.0,
    "ambulance_percentage": 1.0,
    "ambulance_schedule_dependent": 0.8,
    "ambulance_covered": 1.0,
    "cumulative_bonus_percentage": 1.0,
    "cumulative_bonus_schedule_dependent": 0.8,
    "specific_disease_waiting_multi": 1.0,
    "specific_disease_waiting_single": 1.0,
    "maternity_waiting_present": 1.0,
    "maternity_waiting_excluded": 1.0,
    "organ_donor_covered": 1.0,
    "organ_donor_definition_only": 0.2,
    # Medium specificity — generic or non-primary
    "free_look_non_primary_duration": 0.5,
    "care_age_schedule_copay_component": 0.5,
    "renewability_definition_only": 0.2,
    "claim_settlement_definition_only": 0.2,
    "ayush_definition_only": 0.2,
    "ambulance_definition_only": 0.2,
