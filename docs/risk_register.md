...
| R25 | 122 zero-clause policies block full-corpus extraction coverage | High | Very high | DSE-024 classified the original 132 failures and recovered Phase C regression to 122; next mitigation is fallback heading promotion for low-confidence structural headings, not global threshold lowering | — | Active |
